    ...
    if (document.documentElement.clientWidth > 768) {
        categoryBtn.addEventListener("mouseover", (e) => {
            ...
            categoryBtns.forEach((otherBtn) => {
                otherBtn.classList.remove("item--active");
            });
...
//*Закрываем каталог по клику на подкатегорию
const subcategoryItems = document.querySelectorAll(".header-catalog_sub-category .main-categories_item");
